...
export const productsTable = pgTable('products', {
  ...
  compare_price: integer('compare_price').notNull(),
...
export const ordersTable = pgTable('orders', {
  ...
  total_amount: decimal('total_amount', {mode: "number"}).notNull(),
  subtotal: decimal('subtotal', {mode: "number"}).notNull(),
  tax_amount: decimal('tax_amount', {mode: "number"}),
  shipping_amount: decimal('shipping_amount', {mode: "number"}),
